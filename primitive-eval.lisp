...
(defun eval. (e a)
       (cond
              ...
              ((eq (car e) (quote cons)) (cons (eval. (car (cdr e)) a)
                                          (eval. (car (cdr (cdr e))) a)))
              ((eq (car e) (quote cond)) (evcon. (cdr e) a)) ((quote t) (eval. (cons (assoc. (car e) a)
                                                                                    (cdr e))
                                                                                a))))
              ((eq (car (car e)) (quote label)) (eval. (cons (car (cdr (cdr (car e)))) (cdr e))
                                                        (cons (cons (car (cdr (car e))) (cons (car e) (quote ()))) a)))
              ((eq (car (car e)) (quote lambda)) (eval. (car (cdr (cdr (car e))))
